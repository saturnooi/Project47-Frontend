...
import { CreateAccessoryComponent as CreateAccessoryComponentType } from '@app/_components/create-accessory/create-accessory.component';
import { TakeInOutComponent as TakeInOutComponentType } from '@app/_components/take-in-out-accessory/take-in-out-accessory.component';
...
export class AccessoriesComponent implements OnInit {
  ...
  async showCreateAccessoryTab(): Promise<void> {
    const { CreateAccessoryComponent } = await import(
      '@app/_components/create-accessory/create-accessory.component'
    );
  ...
  async showTakeInOutTab(): Promise<void> {
    const { TakeInOutComponent } = await import(
      '@app/_components/take-in-out-accessory/take-in-out-accessory.component'
    );
